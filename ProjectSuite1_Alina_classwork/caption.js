...
function caption_CreateControl(element, m_static)
{
	...
	caption_doResize(element, element.m_minWidth + 10);
...
function caption_startDrag(e)
{
	...
	{
		if (!isIE && this._capture != null) { this.releaseCapture(); this.m_captured = false; }
...
function caption_endDrag(e)
{
	...
	if (element.m_static == false)
	{
		if (!isIE && this._capture == null) return;
...
{
	var minWidth = obj.m_captionDiv.offsetWidth + 40;
